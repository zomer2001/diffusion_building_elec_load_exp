...
# 定义稀疏率和数据长度
sparsity_rates = [100,300,500,1100,700,900]
lengths = [2160]
    ...
    if len(parts) >= 4:
        ...
        if length == 2160 and sparsity in sparsity_rates:
            ...
            for method in methods:
                ...
                epoch_map = {
                    'oridata': {100: 5, 300: 4, 500: 5, 700: 4, 900: 3, 1100: 3},
                    'CDDM': {100: 15, 300: 12, 500: 15, 700: 12, 900: 10, 1100: 10},
                    'ours': {100: 10, 300: 10, 500: 10, 700: 10, 900: 10, 1100: 10},
                    'ours_gen': {100: 10, 300: 8, 500: 10, 700: 8, 900: 6, 1100: 6},
                    'timegan': {100: 15, 300: 12, 500: 15, 700: 12, 900: 10, 1100: 10},
                    'cgan': {100: 15, 300: 12, 500: 15, 700: 12, 900: 10, 1100: 10}
                }
...
# 保存所有结果到总 CSV
if results_all:
    output_dir = r'..\results\lstm_260405_fill_result'
    if not os.path.exists(output_dir):
        os.makedirs(output_dir)
