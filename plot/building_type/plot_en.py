...
def create_combined_plot(stats_df, sample_size):
    ...
    ax1.set_xlabel('Building Type', fontweight='semibold', color='black', fontsize=24)
    ax1.set_ylabel('Number of Buildings', fontweight='semibold', color='black', fontsize=21)
...
if __name__ == "__main__":
    ...
    fig.savefig('building_type_analysis_en.pdf', bbox_inches='tight', dpi=600)
    fig.savefig('building_type_analysis_en.png', bbox_inches='tight', dpi=600)
