...
if our_method_name in smooth_curves:
    ...
    if band_x:
        ...
        ax.fill_between(
            ...
            band_y_ours,
            band_y_best,
            where=np.array(band_y_best)
                  > np.array(band_y_ours),
            color='lightgray',
            alpha=0.6,
            zorder=4
        )
...
for text in legend.get_texts():
    text.set_fontname('Arial Narrow')
...
print("图像已保存：")
print("Generalization_Results.pdf")
print("Generalization_Results.png")