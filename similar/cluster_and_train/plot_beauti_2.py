...
ax.set_xlabel('Distribution Shift (MMD)')
...
plt.tight_layout()
plt.savefig('Generalization_Results.pdf', dpi=300, bbox_inches='tight')
plt.savefig('Generalization_Results.png', dpi=300, bbox_inches='tight')
plt.show()
